...
public class LocationService extends Service {
    ...
    private com.example.javachipnavigationbar.Running.MyLocationListener locationListener;
    ...
    public void onCreate() {
        ...
        locationListener = new com.example.javachipnavigationbar.Running.MyLocationListener();
    ...
    private void addNotification() {
        ...
        /*Intent intent = new Intent(this, com.example.javachipnavigationbar.Running.running_main.class);
    ...
    protected void saveJourney() {
        ...
        journeyData.put(com.example.javachipnavigationbar.Running.JourneyProviderContract.J_distance, getDistance());
        journeyData.put(com.example.javachipnavigationbar.Running.JourneyProviderContract.J_DURATION, (long) getDuration());
        journeyData.put(com.example.javachipnavigationbar.Running.JourneyProviderContract.J_DATE, getDateTime());

        long journeyID = Long.parseLong(getContentResolver().insert(com.example.javachipnavigationbar.Running.JourneyProviderContract.JOURNEY_URI, journeyData).getLastPathSegment());
        ...
        for(Location location : locationListener.getLocations()) {
            ...
            locationData.put(com.example.javachipnavigationbar.Running.JourneyProviderContract.L_JID, journeyID);
            locationData.put(com.example.javachipnavigationbar.Running.JourneyProviderContract.L_ALTITUDE, location.getAltitude());
            locationData.put(com.example.javachipnavigationbar.Running.JourneyProviderContract.L_LATITUDE, location.getLatitude());
            locationData.put(com.example.javachipnavigationbar.Running.JourneyProviderContract.L_LONGITUDE, location.getLongitude());

            getContentResolver().insert(com.example.javachipnavigationbar.Running.JourneyProviderContract.LOCATION_URI, locationData);
        }
