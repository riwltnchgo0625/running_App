...
public class JourneyProvider extends ContentProvider {
    ...
    static {
        ...
        matcher.addURI(com.example.javachipnavigationbar.Running.JourneyProviderContract.AUTHORITY, "journey", 1);
        matcher.addURI(com.example.javachipnavigationbar.Running.JourneyProviderContract.AUTHORITY, "journey/#", 2);
        matcher.addURI(com.example.javachipnavigationbar.Running.JourneyProviderContract.AUTHORITY, "location", 3);
        matcher.addURI(com.example.javachipnavigationbar.Running.JourneyProviderContract.AUTHORITY, "location/#", 4);
    }
